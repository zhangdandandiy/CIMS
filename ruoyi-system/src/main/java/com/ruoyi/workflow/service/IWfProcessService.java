...
public interface IWfProcessService {
     ...
     * @return
     */
    TableDataInfoFlowable<WfDefinitionVo> selectPageStartProcessList(ProcessQuery processQuery, PageQuery pageQuery);
     ...
     * @param pageQuery 分页参数
     */
    TableDataInfoFlowable<WfTaskVo> selectPageOwnProcessList(ProcessQuery processQuery, PageQuery pageQuery);
     ...
     * @param pageQuery 分页参数
     */
    TableDataInfoFlowable<WfTaskVo> selectPageTodoProcessList(ProcessQuery processQuery, PageQuery pageQuery);
     ...
     * @param pageQuery 分页参数
     */
    TableDataInfoFlowable<WfTaskVo> selectPageClaimProcessList(ProcessQuery processQuery, PageQuery pageQuery);
     ...
     * @param pageQuery 分页参数
     */
    TableDataInfoFlowable<WfTaskVo> selectPageFinishedProcessList(ProcessQuery processQuery, PageQuery pageQuery);
