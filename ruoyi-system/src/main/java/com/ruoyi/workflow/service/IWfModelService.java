...
public interface IWfModelService {
     ...
     * 查询流程模型列表
     */
    TableDataInfoFlowable<WfModelVo> list(WfModelBo modelBo, PageQuery pageQuery);
     ...
     * 查询流程模型列表
     */
    TableDataInfoFlowable<WfModelVo> historyList(WfModelBo modelBo, PageQuery pageQuery);
