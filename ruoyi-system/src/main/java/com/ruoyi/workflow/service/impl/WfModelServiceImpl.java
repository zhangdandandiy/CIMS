...
public class WfModelServiceImpl extends FlowServiceFactory implements IWfModelService {
    ...
    @Override
    public TableDataInfoFlowable<WfModelVo> list(WfModelBo modelBo, PageQuery pageQuery) {
    ...
    @Override
    public TableDataInfoFlowable<WfModelVo> historyList(WfModelBo modelBo, PageQuery pageQuery) {
