...
public class WfDeployController extends BaseController {
    ...
    @GetMapping("/list")
    public TableDataInfoFlowable<WfDeployVo> list(ProcessQuery processQuery, PageQuery pageQuery) {
    ...
    public TableDataInfoFlowable<WfDeployVo> publishList(@RequestParam String processKey, PageQuery pageQuery) {
