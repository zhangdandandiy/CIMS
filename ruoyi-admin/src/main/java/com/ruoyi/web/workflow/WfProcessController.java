package com.ruoyi.web.workflow;
...
public class WfProcessController extends BaseController {
    ...
    public TableDataInfoFlowable<WfDefinitionVo> startProcessList(ProcessQuery processQuery, PageQuery pageQuery) {
    ...
    public TableDataInfoFlowable<WfTaskVo> ownProcessList(ProcessQuery processQuery, PageQuery pageQuery) {
    ...
    public TableDataInfoFlowable<WfTaskVo> todoProcessList(ProcessQuery processQuery, PageQuery pageQuery) {
    ...
    public TableDataInfoFlowable<WfTaskVo> claimProcessList(ProcessQuery processQuery, PageQuery pageQuery) {
    ...
    public TableDataInfoFlowable<WfTaskVo> finishedProcessList(ProcessQuery processQuery, PageQuery pageQuery) {
    ...
    public TableDataInfoFlowable<WfCopyVo> copyProcessList(WfCopyBo copyBo, PageQuery pageQuery) {
